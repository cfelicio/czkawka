                            ...
                            for image_filter in [
                                ...
                                for hash_alg in [
                                    ...
                                    for geometric_invariance in [
                                        ...
                                        let (mut messages, loaded_items) = load_cache_from_file_generalized_by_path::<
                                            czkawka_core::tools::similar_images::ImagesEntry,
                                        >(&file_name, true, &Default::default());
